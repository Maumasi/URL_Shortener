...
// AJAX call to our API
		$.ajax({
			type: 'POST',
			url: 'http://162.243.247.134/v1/shorten-url',
			data: url,
...
// AJAX call to our API
		$.ajax({
			type: 'POST',
			url: 'http://162.243.247.134/v1/update-url',
			data: editUrl,
...
// AJAX call to our API
		$.ajax({
			type: 'POST',
			url: 'http://162.243.247.134/v1/remove-url',
...
// show all DB records
	$.ajax({
		type: 'GET',
		url: 'http://162.243.247.134/v1/all-urls',
		// data: url,
					...
					.append(
						"<div class='panel panel-default'>" +
						  "<div class='panel-heading'>" +
						    "<h3 class='panel-title'><a href='http://162.243.247.134/go/" + urlData.maumasiFyKey + "'>Short link: http://162.243.247.134/go/" + urlData.maumasiFyKey + "</a></h3>" +
						  "</div>" +
