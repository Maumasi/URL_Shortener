...
describe('API', () => {
  ...
  it('Test API status route: /maumasi.fy/v1.1.0/status', (done) => {
    request(server)
      .get('/maumasi.fy/v1.1.0/status')
  ...
  it('Test shorten url route: /maumasi.fy/v1.1.0/shorten-url', (done) => {
    request(server)
      .post('/maumasi.fy/v1.1.0/shorten-url')
      .send({
  ...
  it('Test update url route: /maumasi.fy/v1.1.0/update-url', (done) => {
    request(server)
      .post('/maumasi.fy/v1.1.0/update-url')
      .send({
  ...
  it('Test delete short link and url route: /maumasi.fy/v1.1.0/remove-url', (done) => {
    request(server)
      .post('/maumasi.fy/v1.1.0/remove-url')
      .send({
